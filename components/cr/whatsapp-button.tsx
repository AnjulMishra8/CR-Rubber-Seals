  ...
  return (
    <a
      href={`https://wa.me/${company.whatsapp}?text=${encodeURIComponent(
        'Hello CR Rubber & Seals, I would like to enquire about your sealing products.',
      )}`}
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-whatsapp px-4 py-3 text-sm font-bold text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 hover:bg-whatsapp-dark"
