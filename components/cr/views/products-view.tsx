  ...
  return (
    <div className="bg-background">
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        {/* Category filters */}
        <div className="mb-10 flex gap-2 overflow-x-auto pb-2 lg:flex-wrap lg:overflow-x-visible lg:pb-0 [-webkit-overflow-scrolling:touch] [scrollbar-width:thin] [scrollbar-color:rgba(0,0,0,0.2)_transparent]">
          {categories.map((cat) => (
            <button
              key={cat}
